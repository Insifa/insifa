...
RESOURCES += src/qt/insifa.qrc src/qt/insifa_locale.qrc

TRANSLATIONS += src/qt/locale/insifa_bg.ts \
                src/qt/locale/insifa_de.ts \
                src/qt/locale/insifa_en.ts \
                src/qt/locale/insifa_es.ts \
                src/qt/locale/insifa_fi.ts \
                src/qt/locale/insifa_fr.ts \
                src/qt/locale/insifa_it.ts \
                src/qt/locale/insifa_ja.ts \
                src/qt/locale/insifa_pl.ts \
                src/qt/locale/insifa_pt.ts \
                src/qt/locale/insifa_ru.ts \
                src/qt/locale/insifa_sk.ts \
                src/qt/locale/insifa_sv.ts \
                src/qt/locale/insifa_vi.ts \
                src/qt/locale/insifa_zh_CN.ts \
                src/qt/locale/insifa_zh_TW.ts
