...
#   c) node1 mines 32 blocks, so now node 0 has 500000ISF, node 1 has 4250ISF, node2 has none.
#   d) node0 sends 601 ISF to node2, in two transactions (301 ISF, then 300 ISF).
