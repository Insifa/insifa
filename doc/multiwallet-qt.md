...
In order to support loading of multiple wallets in insifa-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is insifa.cpp.
...
Changes to insifa.cpp
----------------------
insifa.cpp is the entry point into insifa-qt, and as such, will require some minor modifications to provide hooks for
