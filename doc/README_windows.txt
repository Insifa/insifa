...
Intro
-----
Insifa (ISF) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. Insifa utilizes an energy efficient proof-of-stake algorithm,
...
Setup
-----
Unpack the files into a directory and run insifa-qt.exe.

Insifa Core is the original Insifa client and it builds the backbone of the network.
However, it downloads and stores the entire history of Insifa transactions;
