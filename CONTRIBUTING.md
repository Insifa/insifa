Contributing to Insifa Core
==================================

The Insifa Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Insifa Core project, and is not to be
confused with overall Insifa Network Protocol consensus changes.

Whether a pull request is merged into Insifa Core rests with the project merge
...
Patches that change Insifa consensus rules are considerably more involved than
...
Where a patch set proposes to change the Insifa consensus, it must have been
...
The project leader is the release manager for each Insifa Core release.
