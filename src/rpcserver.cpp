...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Insifa features */
        {"insifa", "masternode", &masternode, true, true, false},
        {"insifa", "listmasternodes", &listmasternodes, true, true, false},
        {"insifa", "getmasternodecount", &getmasternodecount, true, true, false},
        {"insifa", "masternodeconnect", &masternodeconnect, true, true, false},
        {"insifa", "masternodecurrent", &masternodecurrent, true, true, false},
        {"insifa", "masternodedebug", &masternodedebug, true, true, false},
        {"insifa", "startmasternode", &startmasternode, true, true, false},
        {"insifa", "createmasternodekey", &createmasternodekey, true, true, false},
        {"insifa", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"insifa", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"insifa", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"insifa", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"insifa", "getmasternodescores", &getmasternodescores, true, true, false},
        {"insifa", "mnbudget", &mnbudget, true, true, false},
        {"insifa", "preparebudget", &preparebudget, true, true, false},
        {"insifa", "submitbudget", &submitbudget, true, true, false},
        {"insifa", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"insifa", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"insifa", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"insifa", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"insifa", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"insifa", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"insifa", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"insifa", "checkbudgets", &checkbudgets, true, true, false},
        {"insifa", "mnsync", &mnsync, true, true, false},
        {"insifa", "spork", &spork, true, true, false},
        {"insifa", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"insifa", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"insifa", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"insifa", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"insifa", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"insifa", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> insifa-cli " + methodname + " " + args + "\n";
}
