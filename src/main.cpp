...
#if defined(NDEBUG)
#error "Insifa cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uisf) are considered zero fee (for relaying and mining)
