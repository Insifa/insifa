...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Insifa Core insifa-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  insifa-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded insifa transaction") + "\n" +
                               "  insifa-tx [options] -create [commands]   " + _("Create hex-encoded insifa transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded insifa transaction
