...
/* Insifa GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Insifa"
#define QAPP_ORG_DOMAIN "insifa.io"
#define QAPP_APP_NAME_DEFAULT "Insifa-Qt"
#define QAPP_APP_NAME_TESTNET "Insifa-Qt-testnet"
