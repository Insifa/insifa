...
/** Utility functions used by the Insifa Qt UI.
 */
namespace GUIUtil
{
...
// Render ISF addresses in monospace font
...
// Parse "insifa:" URI into recipient object, return true on successful parsing
